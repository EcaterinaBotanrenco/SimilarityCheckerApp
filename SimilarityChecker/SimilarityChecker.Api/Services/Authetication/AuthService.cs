...
//        {
//            // Verificăm dacă email-ul nu este deja folosit
...
//                RolesCsv = string.IsNullOrWhiteSpace(request.Role) ? "User" : request.Role
//            };
//            _db.AppUsers.Add(newUser);
//            await _db.SaveChangesAsync();

//            // Generăm un token pentru utilizator
...
//                    Roles = newUser.RolesCsv.Split(',', StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries)
//                }
//            };
//        }
